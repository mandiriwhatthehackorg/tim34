...
public class BindingViewPagerAdapter<T> extends PagerAdapter implements BindingCollectionAdapter<T> {
    ...
    private OnItemDataBind<T> itemDataBinding;
    ...
    public OnItemDataBind<T> getItemDataBinding() {
        return itemDataBinding;
    }

    public void setItemDataBinding(OnItemDataBind<T> itemDataBinding) {
    ...
    public void onBindBinding(ViewDataBinding binding, int variableId, @LayoutRes int layoutRes, int position, T item) {
        ...
        if (itemDataBinding != null) itemDataBinding.onItemDataBind(binding, position, item);
    }
