package com.mandiri.binding.bindingcollectionadapter.collections;
...
public class MergeObservableList<T> extends AbstractList<T> implements ObservableList<T> {
    ...
    /**
     * Inserts the given item into the merge list at specific index.
     */
    public MergeObservableList<T> insertItem(T object, int at) {
        lists.add(at, Collections.singletonList(object));
        modCount += 1;
        listeners.notifyInserted(this, at, 1);
        return this;
    }
